...
const BasketPage = () => {
  ...
  if (groupedItems.length === 0) {
    return (
      <div className="container mx-auto p-4 flex flex-col items-center justify-center min-h-[50vh]">
        <h1 className="text-2xl font-bold mb-6 text-gray-800">Sua cesta</h1>
        <p className="text-gray-600 text-lg">Sua cesta está vazia</p>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto p-4 max-w-6xl">
      <h1 className="text-2xl font-bold mb-4">Sua Cesta</h1>
